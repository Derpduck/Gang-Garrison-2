// damageGenerator( sourcePlayer, damagedObject, damageDealt, damageType (Damage Indicator) )
var object;
...
if(object_is_ancestor(object, Character) or object == Character )
    ...
    damageSentry( argument0, argument1, argument2, argument3 );
else if(object_is_ancestor(object, Generator) or object == Generator )
    damageGenerator( argument0, argument1, argument2, argument3 );
