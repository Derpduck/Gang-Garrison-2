...
draw_set_alpha(global.opacityHpHudForeground / 100);
...
draw_text_color(xoffset+xpos+24, yoffset+ypos+18, hpText, hpColor, hpColor, hpColor, hpColor, global.opacityHpHudForeground / 100);
