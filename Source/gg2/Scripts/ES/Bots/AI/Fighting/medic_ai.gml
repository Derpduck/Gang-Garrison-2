...
if !isHealing{
    ...
    if patient == -1{
        ...
        if nearestEnemy!=-1 and !object.currentWeapon.ubering{
            ...
            and !collision_line(object.x,object.y,nearestEnemy.x,nearestEnemy.y,Obstacle,true,true){
                //i can see him
                if task != 'objective'{
                    //run away
...
//FOLLOWING//
if patient != -1 and isHealing{
    if point_distance(object.x, object.y, patient.x, patient.y) < 150{
        // Pulled 150 out of the air, correct if necessary.
