...
if (ds_map_exists(global.bannedSavedUsers, playerIP))
{
    ...
    if (file_exists(working_directory + "\DSM\Banned_Users.txt"))
    {
        ...
        var fileHandle, banMapKey;
        fileHandle = file_text_open_write(working_directory + "\DSM\Banned_Users.txt");
        ...
        {
            file_text_write_string(fileHandle, string(banMapKey) + "@" + ds_map_find_value(global.bannedSavedUsers, banMapKey));
